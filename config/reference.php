 ...
 *     cache?: bool|array{
 *         enabled?: bool|Param, // Default: true
 *         type?: "ttl"|"last_modified"|"none"|Param, // Default: null
 *     },
 *     esi?: bool|array{
 *         enabled?: bool|Param, // Default: true
 *         response_cache_strategy?: "default"|"shortest_response"|Param, // Default: "default"
 *     },
 *     collections?: list<scalar|Param|null>,
 *     site?: array{
 *         identification?: "domain"|"path"|Param, // Deprecated: will be removed in 6.0 // Default: "domain"
 *         class?: scalar|Param|null, // Default: "Softspring\\CmsBundle\\Entity\\Site"
 *         throw_not_found?: bool|Param, // Default: true
 *     },
 *     block?: array{
 *         class?: scalar|Param|null, // Default: "Softspring\\CmsBundle\\Entity\\Block"
 *         find_field_name?: scalar|Param|null, // Default: "id"
 *         cache?: array{
 *             enabled?: bool|Param,
 *             type?: "ttl"|"none"|Param, // Default: null
 *         },
 *         types?: list<array{ // Default: []
 *             name?: scalar|Param|null, // Default: null
 *             description?: scalar|Param|null, // Default: null
 *             admin_form?: scalar|Param|null,
 *             render_template?: scalar|Param|null,
 *         }>,
 *     },
 *     route?: array{
 *         class?: scalar|Param|null, // Default: "Softspring\\CmsBundle\\Entity\\Route"
 *         path_class?: scalar|Param|null, // Default: "Softspring\\CmsBundle\\Entity\\RoutePath"
 *         find_field_name?: scalar|Param|null, // Default: "id"
 *         restricted_paths?: list<scalar|Param|null>,
 *     },
 *     content?: array{
 *         content_class?: scalar|Param|null, // Default: "Softspring\\CmsBundle\\Entity\\Content"
 *         content_version_class?: scalar|Param|null, // Default: "Softspring\\CmsBundle\\Entity\\ContentVersion"
 *         page_class?: scalar|Param|null, // Default: "Softspring\\CmsBundle\\Entity\\Page"
 *         find_field_name?: scalar|Param|null, // Default: "id"
 *         save_compiled?: bool|Param, // Default: true
 *         autocompile_on_save?: bool|Param, // Default: false
 *         autocompile_on_publish?: bool|Param, // Default: true
 *         prefix_compiled?: scalar|Param|null, // Default: ""
 *         cache?: array{
 *             enabled?: bool|Param,
 *             type?: "ttl"|"last_modified"|"none"|Param, // Default: null
 *         },
 ...
 *     },
 *     menu?: array{
 *         class?: scalar|Param|null, // Default: "Softspring\\CmsBundle\\Entity\\Menu"
 *         item_class?: scalar|Param|null, // Default: "Softspring\\CmsBundle\\Entity\\MenuItem"
 *         find_field_name?: scalar|Param|null, // Default: "id"
 *         cache?: array{
 *             enabled?: bool|Param,
 *             type?: "ttl"|"none"|Param, // Default: null
 ...
 *     section?: array{
 *         class?: scalar|Param|null, // Default: "Softspring\\CmsSectionsPlugin\\Entity\\Section"
 *         version_class?: scalar|Param|null, // Default: "Softspring\\CmsSectionsPlugin\\Entity\\SectionVersion"
 *         find_field_name?: scalar|Param|null, // Default: "id"
 *         save_compiled?: bool|Param, // Default: true
 *         autocompile_on_save?: bool|Param, // Default: false
 *         autocompile_on_publish?: bool|Param, // Default: true
 ...
 *     },
 *     filesystem?: array{
 *         path?: scalar|Param|null, // Default: "%kernel.project_dir%/public/media"
 *         url?: scalar|Param|null, // Default: "/media"
 *     },
 *     media?: array{
 *         class?: scalar|Param|null, // Default: "Softspring\\MediaBundle\\Entity\\Media"
 *         find_field_name?: scalar|Param|null, // Default: "id"
 *         admin_controller?: bool|Param, // Default: true
 *     },
 *     version?: array{
 *         class?: scalar|Param|null, // Default: "Softspring\\MediaBundle\\Entity\\MediaVersion"
 *         find_field_name?: scalar|Param|null, // Default: "id"
 *     },
 *     types?: array<string, array{ // Default: []
 *         type?: "video"|"image"|Param, // Default: "image"
 *         name?: scalar|Param|null,
 *         private?: bool|Param, // Default: false
 *         description?: scalar|Param|null,
 *         generator?: scalar|Param|null, // Default: "Softspring\\MediaBundle\\Media\\DefaultNameGenerator"
 ...
 *             minPixels?: int|Param,
 *             maxPixels?: int|Param,
 *             allowSquare?: bool|Param,
 *             allowLandscape?: bool|Param,
 *             allowPortrait?: bool|Param,
 *             detectCorrupted?: bool|Param,
 *             mimeTypes?: list<scalar|Param|null>,
 *             maxSize?: scalar|Param|null,
 *             binaryFormat?: bool|Param,
 *         },
 ...
 *                 binaryFormat?: bool|Param,
 *             },
 *             type?: "jpeg"|"png"|"webp"|"keep"|"apng"|"avif"|Param,
 *             scale_width?: int|Param,
 *             scale_height?: int|Param,
 *             png_compression_level?: int|Param,
 *             webp_quality?: int|Param,
 *             jpeg_quality?: int|Param,
 *             avif_quality?: int|Param,
 *             flatten?: bool|Param,
 *             resolution-x?: int|Param,
 *             resolution-y?: int|Param,
 *             resampling-filter?: scalar|Param|null,
 *             resolution-units?: scalar|Param|null,
 *             from?: scalar|Param|null, // Default: "_original"
 *         }>,
 *         pictures?: array<string, array{ // Default: []
 *             img?: array{
 *                 src_version?: scalar|Param|null, // Default: "_original"
 *             },
 *             sources?: list<array{ // Default: []
 *                 srcset?: list<array{ // Default: []
 *                     version?: scalar|Param|null,
 *                     suffix?: scalar|Param|null, // Default: ""
 *                 }>,
 *                 attrs?: list<scalar|Param|null>,
 *             }>,
 *         }>,
 *         video_sets?: array<string, array{ // Default: []
 *             sources?: list<array{ // Default: []
 *                 version?: scalar|Param|null,
 *                 attrs?: list<scalar|Param|null>,
 *             }>,
 *             poster_version?: scalar|Param|null,
 *             attrs?: list<scalar|Param|null>,
 *         }>,
 *     }>,
 * }
 * @psalm-type SfsTranslatableConfig = array{
 *     api?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         driver?: "google"|Param, // Default: "google"
 *     },
 * }
 * @psalm-type SfsTwigExtraConfig = array{
 *     active_for_routes_extension?: bool|array{
 *         enabled?: bool|Param, // Default: true
 *     },
 *     routing_extension?: bool|array{
 *         enabled?: bool|Param, // Default: true
 *     },
 *     date_span_extension?: bool|array{
 *         enabled?: bool|Param, // Default: true
 *     },
 *     instanceof_extension?: bool|array{
 *         enabled?: bool|Param, // Default: true
 *     },
 *     encore_entry_sources_extension?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         public_path?: scalar|Param|null, // Default: "%kernel.project_dir%/public"
 *     },
 * }
 * @psalm-type SfsUserConfig = array{
 *     class?: scalar|Param|null, // Default: "App\\Entity\\User"
 *     entity_manager?: scalar|Param|null, // Default: "default"
 *     login?: array{
 ...
 *     history?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         class?: scalar|Param|null, // Default: "App\\Entity\\UserAccess"
 *     },
 *     confirm_email?: bool|array{
 *         enabled?: bool|Param, // Default: true
 *     },
 *     reset_password?: array{
 *         token_ttl?: int|Param, // Default: 86400
 *     },
 *     impersonate_bar?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         switch_role?: scalar|Param|null, // Default: "ROLE_ALLOWED_TO_SWITCH"
 *         switch_route?: scalar|Param|null, // Default: "configure_switch_route"
 *         switch_route_params?: list<scalar|Param|null>,
 *         switch_parameter?: scalar|Param|null, // Default: "_switch_user"
 *     },
 *     oauth?: array{
 *         facebook?: array{
 *             application_id?: scalar|Param|null,
 *             application_secret?: scalar|Param|null,
 *             login_create?: bool|Param, // Default: false
 *         },
 *     },
 * }
